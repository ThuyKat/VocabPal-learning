# AGENTS.md — VocabPal Learning Project
...
- **Codex** - Tech lead and scrum master guiding the process
...
- When Katie asks Codex to do something, add it to the session log right after doing it
